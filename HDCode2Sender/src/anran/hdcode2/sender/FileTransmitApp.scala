...
//          }
        ...
        {
          val f = new File("C:\\Users\\kris\\Desktop\\SoftLight\\SLRCode\\SLRCode\\bin\\Debug\\groundtruth\\1_0.2_0.2_10_1234_1234\\" + index.toString() + ".csv")
          val f1 = new File("C:\\Users\\kris\\Desktop\\SoftLight\\SLRCode\\SLRCode\\bin\\Debug\\groundtruth\\1_0.2_0.2_10_1234_1234\\" + (index + 1).toString() + ".csv")
          ...
          while (!eof) {
            ...
            outstream(symbol)
            if (data_count == (144 - 8 - 8) * (GlobalProperty.PhysicalProperty.BlockCountX * GlobalProperty.PhysicalProperty.BlockCountY - 1)) {
              eof = true
            } 
          }
        }
