...
/**
 * @author anran
 * Physical properties that is used in physical layer, doing (camera data to located points) or (data units to images)
...
class PhysicalProperty(blockCountX:Int,blockCountY:Int,blockSize:Int) {
  ...
  var CaptureProperty:CaptureProperty=null
